    ...
    icon: (props) => (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M19.5 14.25V6.75A2.25 2.25 0 0017.25 4.5H6.75A2.25 2.25 0 004.5 6.75v10.5A2.25 2.25 0 006.75 19.5h6.75"
        />
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M16.5 19.5l2.25-2.25M18.75 17.25V21M9 8.25h6M9 12h3"
        />
      </svg>
    ),
  },
    ...
    icon: (props) => (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87M16 3.13a4 4 0 010 7.75M8 3.13a4 4 0 100 7.75M12 21v-4m0 0a4 4 0 00-4-4h0a4 4 0 014-4h0a4 4 0 014 4h0a4 4 0 00-4 4z"
        />
      </svg>
    ),
  },
...
// CoreTeam için navigasyon öğeleri
const coreTeamNavigation: SidebarItem[] = [
  {
    name: 'CoreTeam Paneli',
    href: '/dashboard/coreteam',
    icon: (props) => (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
  ...
  },
  {
    ...
    href: '/dashboard/coreteam/my-events',
    icon: (props) => (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
  ...
  useEffect(() => {
    if (user) {
      ...
      if (role === 'admin') {
        ...
        setNavigationItems(coreTeamNavigation);
      } else {
        ...
        <div className="mt-5 flex flex-col flex-1">
          <nav className="flex-1 space-y-1 px-2" aria-label="Sidebar">
            {navigationItems.map((item) => {
              // Sadece tam eşleşme kontrolü yapıyoruz
              // Böylece "/dashboard/coreteam/tasks" sayfasındayken sadece "Görevler" menüsü aktif olacak
        ...
        <div className="px-4 py-4">
          <div className="flex items-center">
            <div className="flex-shrink-0">
              <div className="relative w-10 h-10 rounded-full bg-gradient-to-r from-blue-500 to-blue-600 flex items-center justify-center text-white font-medium text-lg shadow-md">
                {userName.charAt(0).toUpperCase()}
                <span className="absolute bottom-0 right-0 block h-2.5 w-2.5 rounded-full bg-green-400 border-2 border-white dark:border-gray-900"></span>
              </div>
            </div>
            <div className="ml-3">
              ...
              <div className="flex items-center">
                <span className={`inline-flex items-center rounded-full px-2 py-0.5 text-xs ${
                  ...
                  {userRole === 'admin' ? 'Yönetici' : userRole === 'coreteam' ? 'CoreTeam' : 'Kullanıcı'}
                </span>
              </div>
            </div>
          </div>
